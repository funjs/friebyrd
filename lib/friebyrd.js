...
(function(root) {
  var Bindings, F, LVar, _, conjunction, disjunction, _this = this;
  ...
  F.disj = function() {
    ...
    return disjunction(_.first(arguments), F.disj.apply(_this, _.rest(arguments)));
  };
  F.conj = function() {
    var clauses;
